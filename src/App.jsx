      ...
      <main>
        ...
        >
          <div className="info-card">
            <div>
              ...
              <h2>
                Build a stack that fits the project.
              </h2>

              <p>
                Compare popular frontend, backend, database,
                language, styling, and DevOps technologies before
                you start building.
              </p>
            </div>
        ...
        >
          <div className="about-copy">
            ...
            <h2>
              A simple way to plan your next development stack.
            </h2>

            <p>
              Dev Stack is a lightweight React experience for
              exploring technologies and collecting the tools you
          ...
          >
            ...
            <p>
              Use the stack builder to explore your options, then
